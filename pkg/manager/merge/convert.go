...
func convertWithMapper(obj runtime.Object, mapping *meta.RESTMapping) runtime.Object {
	...
	var gv = runtime.GroupVersioner(schema.GroupVersions(scheme.PrioritizedVersionsAllGroups()))
	if mapping != nil {
		gv = mapping.GroupVersionKind.GroupVersion()
	}
	if obj, err := runtime.ObjectConvertor(scheme).ConvertToVersion(obj, gv); err == nil {
		return obj
	}
	return obj
}

...
import (
	...
	"github.com/kiosk-sh/kiosk/pkg/client/clientset_generated/clientset"
...
var _ = BeforeSuite(func() {
	testenv = test.NewTestEnvironment(apis.GetAllApiBuilders(nil), openapi.GetOpenAPIDefinitions)

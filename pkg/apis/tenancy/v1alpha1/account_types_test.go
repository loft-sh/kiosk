...
import (
	...
	. "github.com/kiosk-sh/kiosk/pkg/client/clientset_generated/clientset/typed/tenancy/v1alpha1"
)

var _ = Describe("Account", func() {
	var instance Account
	var expected Account
	var client AccountInterface
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.TenancyV1alpha1().Accounts("account-test-valid")

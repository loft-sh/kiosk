...
func autoConvert_v1alpha1_AccountSpec_To_tenancy_AccountSpec(in *AccountSpec, out *tenancy.AccountSpec, s conversion.Scope) error {
	out.SpaceClusterRole = (*string)(unsafe.Pointer(in.SpaceClusterRole))
	out.SpaceDefaultTemplates = *(*[]configv1alpha1.TemplateInstanceSpec)(unsafe.Pointer(&in.SpaceDefaultTemplates))
	out.SpaceLimit = (*int)(unsafe.Pointer(in.SpaceLimit))
...
func autoConvert_tenancy_AccountSpec_To_v1alpha1_AccountSpec(in *tenancy.AccountSpec, out *AccountSpec, s conversion.Scope) error {
	out.SpaceClusterRole = (*string)(unsafe.Pointer(in.SpaceClusterRole))
	out.SpaceDefaultTemplates = *(*[]TemplateInstanceSpec)(unsafe.Pointer(&in.SpaceDefaultTemplates))
	out.SpaceLimit = (*int)(unsafe.Pointer(in.SpaceLimit))
	out.Subjects = *(*[]v1.Subject)(unsafe.Pointer(&in.Subjects))
	return nil
}

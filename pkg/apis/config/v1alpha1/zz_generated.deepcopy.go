...
func (in *AccountSpec) DeepCopyInto(out *AccountSpec) {
	*out = *in
	if in.SpaceClusterRole != nil {
		in, out := &in.SpaceClusterRole, &out.SpaceClusterRole
		*out = new(string)
		**out = **in
	}
	if in.SpaceDefaultTemplates != nil {
		in, out := &in.SpaceDefaultTemplates, &out.SpaceDefaultTemplates
		*out = make([]TemplateInstanceSpec, len(*in))
		copy(*out, *in)
	}
	if in.SpaceLimit != nil {
		in, out := &in.SpaceLimit, &out.SpaceLimit
		*out = new(int)
		**out = **in
	}
	if in.Subjects != nil {
